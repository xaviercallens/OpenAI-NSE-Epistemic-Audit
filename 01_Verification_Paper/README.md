...
- **Zenodo:** concept DOI [`10.5281/zenodo.22696717`](https://doi.org/10.5281/zenodo.22696717) (always resolves to the latest version); v5.6.1 is [`10.5281/zenodo.22828106`](https://doi.org/10.5281/zenodo.22828106). Versions 2.0.0 (`22725347`, `22727801`) carry withdrawn claims and should not be cited.
