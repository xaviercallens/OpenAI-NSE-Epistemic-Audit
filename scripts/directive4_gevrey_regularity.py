...
for n in range(1, max_N + 1):
    ...
    print(f"  {n:3d}  {C_N:18.6e}  {n_fact:18d}  {two_n_fact:18.6e}  {ratio_nfact:12.4e}  {ratio_nfact15:18.6e}")

# ============================================================
# 3. Determine the Gevrey index: Empirical vs Analytical
# ============================================================
...
print(f"""
  ...
  3. Empirical linear fit on small N (N <= 15) yields s_emp ≈ 2.22 due to pre-asymptotic effects.
