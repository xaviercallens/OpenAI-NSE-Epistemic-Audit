...
*   **Audited Manuscript (PDF, 6 pages):** [`OpenAI_NSE_EpistemicAudit.pdf`](OpenAI_NSE_EpistemicAudit.pdf)
*   **LaTeX Source:** [`OpenAI_NSE_EpistemicAudit.tex`](OpenAI_NSE_EpistemicAudit.tex)
...
*   **Audit Script:** [`audit_openai.py`](audit_openai.py) (AST inspector for OpenAI Lean 4 source)
...
|---|---|---|
| **Lean 4 AST Audit** | 0 `sorry`, 0 custom axioms | Syntactically pure |
